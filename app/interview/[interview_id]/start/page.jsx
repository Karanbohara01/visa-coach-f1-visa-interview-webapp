...
//     console.log("VAPI Key present:", Boolean(process.env.NEXT_PUBLIC_VAPI_KEY));
...
//                 {!loading ? < PhoneOff className="h-12 w-12 p-3 bg-red-700 rounded-full text-white cursor-pointer" onClick={() => stopInterview()} /> : <Loader2Icon className="animate-spin" />}
//                 {/* </AlertConfirmation> */}
//             </div>

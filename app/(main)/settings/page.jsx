...
// UI Components & Icons
import { Button } from '@/components/ui/button'
import { CreditCard, Bell, Globe, LogOut, Palette, Settings, User, Loader2 } from 'lucide-react'
...
export default function SettingsPage() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case 'account':
        return <AccountSettings userAuth={userAuth} userProfile={userProfile} />
      case 'appearance':
        return <AppearanceSettings setTheme={setTheme} />
      case 'notifications':
        return <NotificationSettings userProfile={userProfile} />
      case 'preferences':
        return <PreferenceSettings userProfile={userProfile} />
      case 'billing':
        ...
        <div className="w-full md:w-64">
          ...
          <nav className="space-y-1">
            ...
            <div className="pt-4 mt-4 border-t dark:border-gray-700">
              <button
                onClick={handleLogout}
                className="w-full flex items-center gap-3 px-4 py-3 rounded-md text-left text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20"
              >
                <LogOut className="w-4 h-4" />
                Log Out
              </button>
